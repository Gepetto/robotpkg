...
ROS_DEPEND_USE+=		ros-std-msgs

DEPEND_ABI.ros-std-msgs?=	ros-std-msgs>=0.4
DEPEND_DIR.ros-std-msgs?=	../../interfaces/ros-std-msgs

DEPEND_ABI.ros-std-msgs.fuerte?=	ros-std-msgs>=0.4<0.5
...
SYSTEM_SEARCH.ros-std-msgs=\
	...
	'share/std_msgs/${ROS_STACKAGE}:/<version>/s/[^0-9.]//gp'	\
