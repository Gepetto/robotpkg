...
DEPEND_ABI.py-qt-gepetto-viewer-corba?=	${PKGTAG.python}-${PKGTAG.qt}-gepetto-viewer-corba>=5.3.0
DEPEND_DIR.py-qt-gepetto-viewer-corba?=	../../graphics/py-qt-gepetto-viewer-corba
