...
SYSTEM_SEARCH.simple-humanoid-description=\
  ...
  'lib/cmake/simple_humanoid_description/simple_humanoid_descriptionConfigVersion.cmake:/PACKAGE_VERSION/s/[^0-9.]//gp'	\
  'lib/pkgconfig/simple_humanoid_description.pc:/Version/s/[^0-9.]//gp'

DEPEND_USE+=		simple-humanoid-description

DEPEND_ABI.simple-humanoid-description?= simple-humanoid-description>=1.1.0
