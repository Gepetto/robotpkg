...
ifneq (,${SYSTEM_FILES.install-sh})
  export INSTALL=		$(word 1,${SYSTEM_FILES.install-sh})

  export INSTALL_PROGRAM=	${INSTALL} -c ${INSTALL_BIN_FLAGS}
  export INSTALL_SCRIPT=	${INSTALL_PROGRAM}
  export INSTALL_LIB=	${INSTALL_PROGRAM}
  export INSTALL_DATA=	${INSTALL} -c ${INSTALL_DATA_FLAGS}
  export INSTALL_MAN=	${INSTALL} -c ${INSTALL_MAN_FLAGS}

  export INSTALL_PROGRAM_DIR=\
	${INSTALL} -d ${INSTALL_BIN_FLAGS} ${INSTALL_DIR_FLAGS}
  export INSTALL_SCRIPT_DIR=	${INSTALL_PROGRAM_DIR}
  export INSTALL_LIB_DIR=		${INSTALL_PROGRAM_DIR}
  export INSTALL_DATA_DIR=\
	${INSTALL} -d ${INSTALL_DATA_FLAGS} ${INSTALL_DIR_FLAGS}
  export INSTALL_MAN_DIR=\
	${INSTALL} -d ${INSTALL_MAN_FLAGS} ${INSTALL_DIR_FLAGS}
endif
