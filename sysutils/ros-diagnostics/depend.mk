...
DEPEND_ABI.ros-diagnostics?=	ros-diagnostics>=1.6
DEPEND_DIR.ros-diagnostics=	../../sysutils/ros-diagnostics

DEPEND_ABI.ros-diagnostics.fuerte += ros-diagnostics>=1.6<1.7
...
SYSTEM_SEARCH.ros-diagnostics=\
  ...
  'share/diagnostic_aggregator/${ROS_STACKAGE}:/<version>/s/[^0-9.]//gp'			\
  'share/diagnostic_analysis/${ROS_STACKAGE}:/<version>/s/[^0-9.]//gp'			\
  'share/diagnostic_updater/${ROS_STACKAGE}:/<version>/s/[^0-9.]//gp'			\
  'share/self_test/${ROS_STACKAGE}:/<version>/s/[^0-9.]//gp'			\
