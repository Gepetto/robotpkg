...
SYSTEM_SEARCH.qt5-multimedia=\
  'include/{,qt{,5}/{,include/}}Qt{,Multimedia}/qcamera.h'	\
  '{lib,share/qt5/lib,lib/qt5}/libQt5Multimedia.{so,a}'		\
  'lib/pkgconfig/Qt5Multimedia.pc:/Version/s/[^0-9.]//gp'

SYSTEM_PREFIX.qt5-multimedia?=		${SYSTEM_PREFIX:=/qt5} ${SYSTEM_PREFIX}
