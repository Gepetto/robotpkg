...
DEPEND_ABI.ros-executive-smach.fuerte+=	ros-executive-smach>=1.2<1.2.2
...
SYSTEM_SEARCH.ros-executive-smach=\
	...
	'share/executive_smach/${ROS_STACKAGE}:/<version>/s/[^0-9.]//gp'	\
	'share/smach_msgs/${ROS_STACKAGE}:/<version>/s/[^0-9.]//gp'	\
